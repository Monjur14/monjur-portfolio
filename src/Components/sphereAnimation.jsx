...
const SphereAnimation = () => {
  ...
  return (
    <div className="animation-wrapper w-full h-full flex justify-center items-center">
      <div className="sphere-animation w-full h-full flex justify-center items-center">
        <svg className="sphere w-full h-auto" viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)">
          <defs>
          ...
          <path d="M284.707 284.34c-77.617 77.617-162.303 118.773-189.152 91.924-26.848-26.848 14.308-111.534 91.924-189.15C265.096 109.508 349.782 68.352 376.63 95.201c26.849 26.849-14.307 111.534-91.923 189.139z"/>
