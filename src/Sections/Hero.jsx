      ...
      <header className="contain head__bg">
        ...
        <div className="flex flex-col xmd:flex-row gap-10 lg:gap-0 mt-0 xmd:mt-5">
            <div className="basis-1/2">
                ...
                <div className=" border-white -space-y-[6.18rem] md:-space-y-[4.4rem] xmd:-space-y-[4.8rem] lg:-space-y-[5.1rem] -mt-7 lg:-mt-3">
                    <svg className="svg1">
                ...
                <div className=" border-white text-lowWhite pr-0 lg:pr-10">
                  <div className="-mt-9 md:-mt-5 text-pretty text-sm">
