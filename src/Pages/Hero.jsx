  ...
  return (
    <div className="w-full min-h-screen bg relative">
      ...
      <header className="contain head__bg">
        <nav className="flex justify-between items-center py-2 md:py-5">
            ...
            <span>
              <Hamburger size={28} color="#ccc"/>
            </span>
        </nav>
        <div className="flex flex-col xmd:flex-row items-center h-[85vh] gap-8 lg:gap-0 mt-0 xmd:mt-5">
            <div className="basis-1/2">              
                <div className=" border-white -space-y-[6.5rem] xsm:-space-y-[5.83rem] md:-space-y-[4.4rem] xmd:-space-y-[4.8rem] lg:-space-y-[5.1rem] xxl:-space-y-[4.2rem] -mt-8 xsm:-mt-2 lg:-mt-3 xxl:-mt-28 ">
                    <svg className="svg1">
                ...
                <div className=" border-white text-lowWhite pr-0 lg:pr-10 leading-[1rem] -mt-10">
